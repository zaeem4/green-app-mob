            ...
            Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  padding: const EdgeInsets.only(left:10,right:40,top: 30,bottom: 10),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text('Flower Type',style: TextStyle(
                        ...
                        Padding(
                          ...
                          child: Text('Availible ',style: TextStyle(
                                      ...
                                      children: [
                                        ...
                                        Icon(
                                          ...
                                          size: 20,
                                            ...
                                            : data[index].icon==Icons.warning_amber_outlined?
                                        Icon(
                                          data[index].icon,
...
class StockList{
  ...
  const StockList(
      {
        this.img, this.name,  this.ammount,this.icon,
      }
      );
}